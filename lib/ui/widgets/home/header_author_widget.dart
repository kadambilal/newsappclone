                      ...
                      child :  Stack(
                        children: [
                           Positioned(child: Image.asset('assets/png/bg.png')),
                            Positioned(top:10, left: 5,height: 125,width: 150,
                              child: Image.network(yazarResmi.toString(),width: 200,height: 200,),),
                          Positioned(top:140, left: 30,height: 125,width: 150,
                            child: Text(yazarAdi.toString(),maxLines: 2,
                            style: TextStyle(color: Colors.white,fontSize: 13),) ,),
                          Positioned(top:10, left: 190,height: 125,width: 220,
                            child: Text(yaziTitle.toString(),maxLines: 2,
                            style: TextStyle(color: Colors.white,fontSize: 25),) ,),
                          Positioned(top:70, left: 190,height: 125,width: 200,
                            child: Text(yaziIcerik.toString(),maxLines: 8,
                            style: TextStyle(color: Colors.white,fontSize: 13),) ,),
                          Positioned(top:185, left: 280,height: 125,width: 200,
